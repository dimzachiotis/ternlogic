...
# | 1  | A                    | 0     | 0       | 0     | 0.5     | 0.5       | 0.5     | 1     | 1       | 1     |
# | 2  | B                    | 0     | 0.5     | 1     | 0       | 0.5       | 1       | 0     | 0.5     | 1     |
# | 3  | 1-Α                  | 1     | 1       | 1     | 0.5     | 0.5       | 0.5     | 0     | 0       | 0     |
# | 4  | 1-Β                  | 1     | 0.5     | 0     | 1       | 0.5       | 0       | 1     | 0.5     | 0     |
# | 5  | ((2Α-1)(2Β-1)+1)/2   | 1     | 0.5     | 0     | 0.5     | 0.5       | 0.5     | 0     | 0.5     | 1     |
# | 6  | 1-((2Α-1)(2Β-1)+1)/2 | 0     | 0.5     | 1     | 0.5     | 0.5       | 0.5     | 1     | 0.5     | 0     |
# | 7  | 0.5                  | 0.5   | 0.5     | 0.5   | 0.5     | 0.5       | 0.5     | 0.5   | 0.5     | 0.5   |
# | 8  | ((2Α-1)(2Α-1)+1)/2   | 1     | 1       | 1     | 0.5     | 0.5       | 0.5     | 1     | 1       | 1     |
# | 9  | ((2Β-1)(2Β-1)+1)/2   | 1     | 0.5     | 1     | 1       | 0.5       | 1       | 1     | 0.5     | 1     |
# | 10 | 1-((2Α-1)(2Α-1)+1)/2 | 0     | 0       | 0     | 0.5     | 0.5       | 0.5     | 0     | 0       | 0     |
# | 11 | 1-((2Β-1)(2Β-1)+1)/2 | 0     | 0.5     | 0     | 0       | 0.5       | 0       | 0     | 0.5     | 0     |
...
def tern_op(a, b, i):
    ...
    if i == 0:
        ...
        return ((2*a-1)*(2*b-1)+1)/2
    elif i == 6:
        return 1-(((2*a-1)*(2*b-1)+1)/2)
    elif i == 7:
        return torch.full_like(a,0.5)
    elif i == 8:
        return ((2*a-1)*(2*a-1)+1)/2
    elif i == 9:
        return ((2*b-1)*(2*b-1)+1)/2
    elif i == 10:
        return 1-(((2*a-1)*(2*a-1)+1)/2)
    elif i == 11:
        return 1-(((2*b-1)*(2*b-1)+1)/2)
    elif i == 12:
